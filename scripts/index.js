...
const dataProjects = [
    { id:'0', image: 'images/projects/exp.png', title: 'Squad EXP', link: 'https://www.behance.net/gallery/164164103/EXP', description: 'Logo para time de desenvolvimento da Diretoria de Inovação e Tecnologia do Grupo CEUMA', category: 'design', technologies: 'figma,ai'},
    { id:'1', image: 'images/projects/foodcare.svg', title: 'Food Care', link: 'https://www.behance.net/gallery/164151237/Food-Care', description: 'Identidade visual de uma marca de alimentação natural para pets', category: 'design', technologies: 'figma,ai'},
    { id:'2', image: 'images/projects/seloDaDiversidade.png', title: 'Selo da Diversidade', link: 'https://selodadiversidade.sedihpop.ma.gov.br/', description: 'Landing page e formulário para programa do Governo do Maranhão', category: 'dev', github: '', technologies: 'html ,css, js,ui'},
    { id:'3', image: 'images/projects/ecoKo.png', title: 'EcoKo', link: 'https://www.linkedin.com/posts/laura-melo-91533222b_para-todos-os-donos-de-cachorros-voc%C3%AAs-j%C3%A1-activity-7089274365657137152-06Bi?utm_source=share&utm_medium=member_desktop', description: 'Projeto de design de identidade visual e de produto sustentável', category: 'design', technologies: 'figma,ai'},
    ...
    { id:'5', image: 'images/projects/universo_representacoes.png', title: 'Universo Representações', link: 'https://www.behance.net/gallery/201572409/Universo-Representacoes?', description: 'Logo para empresa de representação comercial', category: 'design', technologies: 'figma,ai'},
    ...
    { id:'7', image: 'images/projects/portifolio.jpg', title: 'Meu portifólio', link: 'http://127.0.0.1/portifolio/index.php?page=', description: 'Portifólio pessoal, com o objetivo de apresentar minhas habilidades, experiências e projetos realizados', category: 'dev', github: 'https://github.com/laumelos/portifolio', technologies: 'html,css,js,ui,ux'}
];
...
const dataExperiences = [
    { title: 'Loja online - Suflora', date: '2020 - 2021', description: 'Início da jornada empreendedora aos 16 anos, criando e gerenciando uma loja online'},
